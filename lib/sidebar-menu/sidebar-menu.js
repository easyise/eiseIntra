 ...
 * 
 * Hacked by Ilya Eliseev at 2017 to meet the following functionality:
 * * jQuery 1.6 compatibility 
 * * 'keep-active' class support
 * 
 */
...
$.sidebarMenu = function(menu) {
  ...
  $(menu).find('li a').click(function(e) {
    ...
    //If the menu is not visible
      ...
      var ul = parent.find("li:not(.keep-active) ul:visible").slideUp(animationSpeed);
      ...
      checkElement.slideDown(animationSpeed, function() {
        ...
        parent.find('li:not(.keep-active).active').removeClass('active');
